...
public class ReadingProperties {
    ...
    public void reading_from_properties_file() throws IOException {
        ...
        //We need property class to use getProperty method ("key")you put key and it will give you value

        Properties properties=new Properties();

        //Create file input stream object to open file as a stream in Java memory
